...
function Main() {
  ...
  return (
    <div className="main min-h-[100vh] pb-[15vh] flex-1  relative">
      ...
      <div className="main-container max-w-[80vw] justify-center  mt-[3rem] m-[auto] flex flex-col gap-[100px]">

        {!showResult ? <>

          <div className="greet ml-[80px] w-[85%] flex flex-col items-center justify-center">
          ...
          <div className="cards flex w-[100%] justify-center   gap-[2.5rem]">
            <div className="card p-[10px] w-[230px] h-[180px] bg-[#cbccce] rounded-[12px] relative hover:bg-[#dfe4ea]">
          ...
          : <div style={{ scrollbarWidth: "none" }} className="result max-h-[69vh] ng-red-400 overflow-y-scroll">
        ...
        <div className="main-bottom  absolute flex flex-col items-center justify-center bottom-4 w-[85%] px-[20px] py-[0px] m-[auto]">
