    ...
    return (
        <div className='sidebar min-h-[100vh] px-[25px] py-[15px] inline-flex flex-col justify-between bg-[#f0f4f9]'>
            <div className="top">
                ...
                <div className='new-chat inline-flex mt-[40px] items-center cursor-pointer gap-[10px] px-[15px] py-[10px] text-[gray] bg-[#e6eaf1] rounded-[50px]'>
                ...
                {extended?<div className="recent flex flex-col">
                    ...
                    <div className='recent-entry flex items-center gap-[10px] p-[10px] pr-[40px] text-[#282828] rounded-[50px] cursor-pointer hover:bg-[#e2e6eb]'>
